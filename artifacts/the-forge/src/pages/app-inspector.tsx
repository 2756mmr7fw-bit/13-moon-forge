        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            <div className="flex-1">
              {finding.page && (
                <code className="text-[10px] bg-muted/80 px-1.5 py-0.5 rounded font-mono mr-2 text-muted-foreground">
                  {finding.page}
                </code>
              )}
              <span className={finding.type === "step" ? "text-muted-foreground text-xs" : ""}>{finding.message}</span>
            </div>
            {finding.detail && (
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="border border-border/40 rounded-xl p-5 bg-muted/10 text-sm text-muted-foreground space-y-2">
        <p className="font-medium text-foreground text-sm">What Forge checks</p>
        <ul className="space-y-1 text-xs leading-relaxed">
          ...
          <li>• Broken pages (HTTP 4xx/5xx), missing titles, forms without actions</li>
        </ul>
