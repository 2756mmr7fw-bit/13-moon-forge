...
import vultrRouter from "./vultr";
import linodeRouter from "./linode";
import neonRouter from "./neon";
...
router.use(digitaloceanRouter);
router.use(vultrRouter);
router.use(linodeRouter);
router.use(neonRouter);
