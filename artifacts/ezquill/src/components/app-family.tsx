...
export function AppFamily({ currentAppId, className }: { currentAppId?: string; className?: string }) {
  return (
    <div className={cn("rounded-xl border border-border bg-secondary/30 p-6 mt-12", className)}>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-muted-foreground line-clamp-2 mt-0.5">{app.tagline}</div>
                </div>
              </div>
            </a>
          );
